...
{
    public class StudentAssessmentItem_AssessmentItemReference_ValueBuilder : ReferenceValueBuilderBase, IContextSpecificReferenceValueBuilder
    {
        protected override bool IsHandled(BuildContext buildContext)
        {
            return buildContext.Matches("StudentAssessmentItem", "AssessmentItemReference");
        }
