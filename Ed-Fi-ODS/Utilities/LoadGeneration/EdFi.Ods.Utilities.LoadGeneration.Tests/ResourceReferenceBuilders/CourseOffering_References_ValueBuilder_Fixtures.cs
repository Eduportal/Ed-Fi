...
{
    public class CourseOffering_References_ValueBuilder_Fixtures
    {
        ...
        public class When_building_a_SessionReference_for_a_CourseOffering_where_no_SchoolReference_yet_exists : 
            When_building_references<SessionReference, CourseOffering>
        {
            // Supplied values
            ...
            protected override void Act()
            {
                ...
                var builder = new CourseOffering_SessionReference_ValueBuilder();
        ...
        public class When_building_a_SessionReference_for_a_CourseOffering_where_a_SchoolReference_already_exists : 
            When_building_references_where_key_unification_context_has_been_established<SessionReference, CourseOffering, Session>
        {
            // Supplied values
            ...
            protected override CourseOffering CreateContainingInstance()
            {
        ...
        public class When_building_a_SchoolReference_for_a_CourseOffering_where_no_SessionReference_yet_exists : 
            When_building_references<SchoolReference, CourseOffering>
        {
            // Supplied values
            ...
            {
                // Create the value builder
                var builder = new CourseOffering_SchoolReference_ValueBuilder();
        ...
        public class When_building_a_SchoolReference_for_a_CourseOffering_where_a_SessionReference_already_exists : 
            When_building_references_where_key_unification_context_has_been_established<SchoolReference, CourseOffering, School>
        {
            // Supplied values
            private const int SuppliedSchoolId = 222;
