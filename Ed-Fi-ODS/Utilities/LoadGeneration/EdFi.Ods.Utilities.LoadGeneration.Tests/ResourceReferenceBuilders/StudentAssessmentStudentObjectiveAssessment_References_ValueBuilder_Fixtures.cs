...
{
    public class StudentAssessmentStudentObjectiveAssessment_References_ValueBuilder_Fixtures
    {
        ...
        public class When_building_a_ObjectiveAssessmentReference_for_a_StudentAssessmentStudentObjectiveAssessment :
        When_building_references_where_key_unification_context_has_been_established<ObjectiveAssessmentReference, StudentAssessmentStudentObjectiveAssessment, ObjectiveAssessment>
        {
            // Supplied values
            ...
            protected override void Act()
            {
                ...
                var builder = new StudentAssessmentStudentObjectiveAssessment_ObjectiveAssessmentReference_ValueBuilder();
