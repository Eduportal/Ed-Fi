...
{
    public class AcademicWeek_References_ValueBuilder_Fixtures
    {
        ...
        public class When_building_a_BeginCalendarDateReference_for_an_AcademicWeek_where_no_EndCalendarDateReference_yet_exists : When_building_references<CalendarDateReference, AcademicWeek>
        {
            // Supplied values
            ...
            protected override void Act()
            {
                ...
                var builder = new AcademicWeek_BeginCalendarDate_ValueBuilder();
        ...
        public class When_building_a_BeginCalendarDateReference_for_an_AcademicWeek_where_an_EndCalendarDateReference_already_exists :
            When_building_references_where_key_unification_context_has_been_established<CalendarDateReference, AcademicWeek ,CalendarDate>
        {
            // Supplied values
            ...
            protected override AcademicWeek CreateContainingInstance()
            {
        ...
        public class When_building_a_EndCalendarDateReference_for_an_AcademicWeek_where_no_BeginCalendarDateReference_yet_exists :
            When_building_references<CalendarDateReference, AcademicWeek>
        {
            // Supplied values
            ...
            {
                // Create the value builder
                var builder = new AcademicWeek_EndCalendarDate_ValueBuilder();
        ...
        public class When_building_a_EndCalendarDateReference_for_an_AcademicWeek_where_an_BeginCalendarDateReference_already_exists :
            When_building_references_where_key_unification_context_has_been_established<CalendarDateReference, AcademicWeek, CalendarDate>
        {
            // Supplied values
            private const int SuppliedEdOrgId = 1001;
