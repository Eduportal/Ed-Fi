...
{
    public class StudentLearningObjective_References_ValueBuilder_Fixtures
    {
        ...
        public class When_building_a_StudentProgramAssociationReference_for_a_StudentLearningObjective_where_no_StudentSectionAssociationReference_yet_exists_and_program_progress_is_equal_to_section_progress :
            When_building_references<StudentProgramAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            ...
            protected override void Act()
            {
                ...
                var builder = new StudentLearningObjective_StudentProgramAssociationReference_ValueBuilder();
            ...
            [Assert]
            public void Should_skip_building_the_value()
            {
                _actualValueBuildResult.ShouldSkip.ShouldBeTrue();
            }
        }

        public class When_building_a_StudentProgramAssociationReference_for_a_StudentLearningObjective_where_no_StudentSectionAssociationReference_yet_exists_and_program_progress_is_greater_than_section_progress :
            When_building_references<StudentProgramAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
        ...
        public class When_building_a_StudentProgramAssociationReference_for_a_StudentLearningObjective_where_no_StudentSectionAssociationReference_yet_exists_and_program_progress_is_less_than_section_progress :
            When_building_references<StudentProgramAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
        ...
        public class When_building_a_StudentProgramAssociationReference_for_a_StudentLearningObjective_where_a_StudentSectionAssociationReference_already_exists :
            When_building_references<StudentProgramAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
            ...
            protected override StudentLearningObjective CreateContainingInstance()
            {
                // Create a containing model with the other reference already set
                return new StudentLearningObjective
                {
        ...
        public class When_building_a_StudentSectionAssociationReference_for_a_StudentLearningObjective_where_no_StudentProgramAssociationReference_yet_exists_and_section_progress_is_equal_to_program_progress :
            When_building_references<StudentSectionAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
            ...
            {
                // Create the value builder
                var builder = new StudentLearningObjective_StudentSectionAssociationReference_ValueBuilder();
                builder.ResourceCountManager = _resourceCountManager;
                builder.Factory = _testObjectFactory;
                builder.ApiSdkReflectionProvider = _apiSdkReflectionProvider;
                builder.ResourcePersister = _resourcePersister;
        ...
        public class When_building_a_StudentSectionAssociationReference_for_a_StudentLearningObjective_where_no_StudentProgramAssociationReference_yet_exists_and_section_progress_is_greater_than_program_progress :
            When_building_references<StudentSectionAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
        ...
        public class When_building_a_StudentSectionAssociationReference_for_a_StudentLearningObjective_where_no_StudentProgramAssociationReference_yet_exists_and_section_progress_is_less_than_program_progress :
            When_building_references<StudentSectionAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
        ...
        public class When_building_a_StudentSectionAssociationReference_for_a_StudentLearningObjective_where_a_StudentProgramAssociationReference_already_exists :
            When_building_references<StudentSectionAssociationReference, StudentLearningObjective>
        {
            // Supplied values
            private const string SuppliedLogicalPropertyPath = "xxx.xxx.xxx";
