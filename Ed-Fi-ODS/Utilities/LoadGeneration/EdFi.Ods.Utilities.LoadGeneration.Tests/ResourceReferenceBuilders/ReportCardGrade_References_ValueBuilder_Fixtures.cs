...
{
    public class ReportCardGrade_References_ValueBuilder_Fixtures
    {
        #region Supported SDK model class structures

        // SDK model classes, trimmed down so they only contain pertinent properties
        ...
        {
            /* A reference to the related Grade resource. */
            public GradeReference gradeReference { get; set; }
        }
        ...
        public class When_building_a_GradeReference_for_a_ReportCardGrade : When_building_references_where_key_unification_context_has_been_established<GradeReference, ReportCardGrade, Grade>
        {
            // Supplied values
            ...
            protected override void Act()
            {
                ...
                var builder = new ReportCardGrade_GradeReference_ValueBuilder();
