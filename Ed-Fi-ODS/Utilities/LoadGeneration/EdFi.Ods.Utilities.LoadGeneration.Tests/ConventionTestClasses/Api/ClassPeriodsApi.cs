...
namespace EdFi.Ods.Utilities.LoadGeneration.Tests.ConventionTestClasses.Api
{
    public class ClassPeriodsApi
    {
        ...
        public ClassPeriodsApi(IRestClient client)
        {
            this.client = client;
        }
        ...
        /// <returns></returns>
        public IRestResponse<List<ClassPeriod>> GetClassPeriodsAll(int? offset, int? limit)
        {
            var request = new RestRequest("/classPeriods", Method.GET);
            ...
            var response = client.Execute<List<ClassPeriod>>(request);
        ...
        /// <param name="name">An indication of the portion of a typical daily session in which students receive instruction in a specified subject (e.g., morning, sixth period, block period, or AB schedules).   NEDM: Class Period  </param>
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns></returns>
        public IRestResponse<ClassPeriod> GetClassPeriodByKey(int? schoolId, string name, string IfNoneMatch)
        {
            var request = new RestRequest("/classPeriods", Method.GET);
            request.RequestFormat = DataFormat.Json;
            ...
            var response = client.Execute<ClassPeriod>(request);
        ...
        /// <param name="IfNoneMatch">The previously returned ETag header value, used here to prevent the unnecessary data transfer of an unchanged resource.</param>
        /// <returns></returns>
        public IRestResponse<ClassPeriod> GetClassPeriodsById(string id, string IfNoneMatch)
        {
            var request = new RestRequest("/classPeriods/{id}", Method.GET);
            request.RequestFormat = DataFormat.Json;
        ...
        /// <returns></returns>
        public IRestResponse DeleteClassPeriodById(string id, string IfMatch)
        {
            var request = new RestRequest("/classPeriods/{id}", Method.DELETE);
            request.RequestFormat = DataFormat.Json;
