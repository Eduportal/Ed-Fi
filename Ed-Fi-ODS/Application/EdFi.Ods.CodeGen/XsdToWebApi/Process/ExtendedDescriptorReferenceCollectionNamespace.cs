namespace EdFi.Ods.CodeGen.XsdToWebApi.Process
{
    ...
    public class ExtendedDescriptorReferenceCollectionNamespace : ProcessChainOfResponsibilityBase
    {
        ...
        public ExtendedDescriptorReferenceCollectionNamespace(IProcessChainOfResponsibility next)
            : base(next)
        {
        }
            ...
            return new ProcessResult
                       {
                               ...
                               ProcessingRuleName = "Extended Descriptor Reference Collection Namespace",
