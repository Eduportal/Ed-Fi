...
//                _result.ResetStatus.ShouldEqual(PasswordResetStatus.RequestExpired);
//            }
//
//            [Test]
...
//            {
//                _result.Message.ShouldEqual("It looks like your password request has expired.  Email verification must happen within 48 hours. Use the box below to try again.");
//            }
//        }
//
//        [TestFixture]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.ResetStatus.ShouldEqual(PasswordResetStatus.BadUsername);
//            }
//
//            [Test]
//            public void Should_not_activate_the_user()
...
//                storedRequest.Secret.ShouldEqual("Fuh");
//            }
//
//            [Test]
...
//                var storedRequest = _user.Get<PasswordResetRequest>();
//                storedRequest.ShouldNotBeNull();
//                storedRequest.ExpirationDate.ShouldEqual(_expectedEpiration);
//            }
//
//            [Test]
//            public void Should_provide_the_secret_so_it_can_be_used_in_an_email()
//            {
//                _result.ShouldEqual("Fuh");
//            }
//        }
//    }
}