...
//using Should;
//using UnitTests.EdFi.Ods.Admin._Stubs;
...
//            {
//                _userRepo.CreatedUsers.Length.ShouldEqual(1);
//                _userRepo.CreatedUsers[0].Auth.Email.ShouldEqual("foo@example.com");
//                _userRepo.CreatedUsers[0].Auth.DisplayName.ShouldEqual("My Test Name");
...
//                _result.UserStatus.ShouldEqual(UserStatus.Created);
//            }
//
//            [Test]
...
//            {
//                _userRepo.CreatedUsers.Length.ShouldEqual(0);
//            }
//
//            [Test]
...
//                _result.UserStatus.ShouldEqual(UserStatus.NeedsEmailConfirmation);
//            }
//        }
//
//        [TestFixture]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.UserStatus.ShouldEqual(UserStatus.AlreadyExists);
//            }
//        }
//
//        [TestFixture]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.UserStatus.ShouldEqual(UserStatus.Failed);
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("Password is required.");
//            }
//
//            [Test]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("ConfirmPassword is required.");
//            }
//
//            [Test]
//            public void Should_not_activate_the_user()
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("Password and Confirm Password must match.");
//            }
//
//            [Test]
//            public void Should_not_activate_the_user()
...
//                updateOperations.Length.ShouldEqual(1);
//                updateOperations[0].New.Permissions.Count.ShouldEqual(1);
//            }
//
//            [Test]
...
//                var updateOperations = _userRepo.UpdatedUsers;
//                updateOperations.Length.ShouldEqual(1);
//                updateOperations[0].Password.ShouldEqual("pass");
//            }
//        }
//
//        [TestFixture]
...
//                _result.Message.ShouldEqual("The password you entered is invalid.");
//                _result.ResetStatus.ShouldEqual(PasswordResetStatus.BadPassword);
//            }
//
//            [Test]
...
//            {
//                var updateOperations = _userRepo.UpdatedUsers;
//                updateOperations.Length.ShouldEqual(0);
//            }
//        }
//
//        [TestFixture]
...
//            public void Should_not_activate_the_user()
//            {
//                _userRepo.UpdatedUsers.Length.ShouldEqual(0);
//            }
//        }
//
//        [TestFixture]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("CurrentPassword is required.");
//            }
//
//            [Test]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("NewPassword is required.");
//            }
//
//            [Test]
//            public void Should_not_do_anything_with_the_user()
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("New Password and Confirm Password must match.");
//            }
//
//            [Test]
//            public void Should_not_activate_the_user()
...
//                _result.Message.ShouldEqual("The Current Password supplied is incorrect");
//            }
//
//            [Test]
...
//            {
//                _result.Message.ShouldEqual("Email is required.");
//                _result.FailingFields.Length.ShouldEqual(1);
//                _result.FailingFields.ShouldContain("email");
//            }
//        }
//
...
//            {
//                _result.Message.ShouldEqual("There are no accounts with the email address 'foo'");
//                _result.FailingFields.Length.ShouldEqual(1);
//                _result.FailingFields.ShouldContain("email");
//            }
//        }
...
//                savedUsers.Length.ShouldEqual(1);
//
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("It looks like our email system is down.  Please try again in a few minutes.");
//            }
//        }
//
//        [TestFixture]
...
//            {
//                _result.Success.ShouldBeFalse();
//                _result.Message.ShouldEqual("The database is unreachable.  Please try again in a few minutes.");
//            }
//
//            [Test]
