namespace EdFi.Ods.Tests.EdFi.Ods.WebApi.Common
{
    ...
    //            HttpContext.Current.Items[OAuthStringConstants.SandboxConnectionString].ShouldEqual(connectionString);
    //        }
    //    }
    ...
    //            result.ShouldEqual(cachedConnectionString);
    //        }
    //    }
    ...
    //            {
    //                re.Response.StatusCode.ShouldEqual(HttpStatusCode.Unauthorized);
    //            }
    //            catch (Exception e)
    //            {
