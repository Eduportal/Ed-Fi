namespace EdFi.Ods.Tests.EdFi.Ods.CommonUtils.Extensions
{
    ...
    public class EnumExtensionsTest {
        public enum TestEnum { one, Two, THREE, NumberFour, ILikeSDE }
        public enum TestEnum16 : short { one, Two, THREE, NumberFour, ILikeSDE }
        [Flags]
        public enum TestFlagsEnum { None = 0, 
                                    TooTall = 1, 
                                    TooHeavy = 1<<1, 
                                    TooAfraid = 1<<2,
                                    All = (1<<3)-1 };
        [Flags] enum TestFlagsEnum64 : long { None = 0,
                                    TooTall = 1, 
                                    TooHeavy = 1<<1, 
                                    TooAfraid = 1<<2,
                                    All = (1<<3)-1 };
        [Flags] enum TestFlagsEnum16 : short { None = 0,
                                    TooTall = 1, 
                                    TooHeavy = 1<<1, 
                                    TooAfraid = 1<<2,
                                    All = (1<<3)-1 };
        const string SecondDesc = "My * Second * One";
        ...
        {
            StringComparison.InvariantCulture.GetName().ShouldEqual("InvariantCulture");
        }
    }
}
