namespace EdFi.Ods.Tests.EdFi.Common
{
    ...
    using global::EdFi.Common.Expando;
    ...
    [Serializable]
    public class ExpandoInstance : global::EdFi.Common.Expando.Expando
    {
    ...
    public class Address
    {
        ...
        public Address()
        {
            this.FullAddress = "32 Kaiea";
            this.Phone = "808 NO-HATE";
            this.Email = "rick@whatsa.com";
        }
    }

    public class User : global::EdFi.Common.Expando.Expando
    {
        public string Email { get; set; }
