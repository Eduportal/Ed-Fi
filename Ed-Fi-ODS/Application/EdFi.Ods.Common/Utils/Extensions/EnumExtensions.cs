...
// <authors> Steve Hatchett, Aaron Wells
...
namespace EdFi.Ods.Common.Utils.Extensions {
    ...
    public static class EnumExtensions {
        ...
        public static bool In(this Enum anEnumValue, Enum value1, Enum value2, params Enum[] additionalValues) {
            if (anEnumValue.Equals(value1) || anEnumValue.Equals(value2)) return true;
            foreach (var value in additionalValues) {
                if (anEnumValue.Equals(value)) return true;
            }
            return false;
        }
        ...
        {
            Int64 value64 = Convert.ToInt64(values);
            Int64 flags64 = Convert.ToInt64(flags);
        ...
        public static TEnum ToEnum<TEnum>(this string value, bool ignoreCase) where TEnum : struct
        {
            ...
            return (TEnum)Enum.Parse(type, value.Replace(" ", "").Trim());
        }
        /// <summary>
        ...
        /// <returns>The enum value whose name matches the given string.</returns>
        public static TEnum ToEnum<TEnum>(this string[] values) where TEnum : struct {
        ...
        /// </returns>
        public static bool IsDefined<TAttribute>(this object value) where TAttribute : Attribute
        {
            try
            {
