...
namespace Test.Common
{
    public static class ServiceHelper
    {
        public static Process StartServiceProcess(string fileName)
        {
            ...
            {
                throw new Exception(fileName + " could not be started. This may be because the file is not present there. Make sure that the relevant project has been built and its executable output copied to the to the specified path.", ex);
            }
            return process;
        }
