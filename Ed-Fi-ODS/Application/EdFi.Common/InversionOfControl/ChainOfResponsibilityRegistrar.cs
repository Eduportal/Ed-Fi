...
namespace EdFi.Common.InversionOfControl
{
    public class ChainOfResponsibilityRegistrar
    {
            ...
            where TService : class
        {
            ...
            var chainTypesToRegister = chainTypes.Where(t => t != typeof(TNullObject)).ToArray();
            ...
            for (int i = 0; i < chainTypesToRegister.Length; i++)
            {
                ...
                if (i == chainTypesToRegister.Length - 1)
                {
                    ...
                    // disable Obsolete warning on this call
#pragma warning disable 612, 618 
                    registration.ServiceOverrides(
                        ServiceOverride
                            .ForKey("next")
                            .Eq(nullObjectRegistrationKey));
...
#pragma warning restore 612, 618
                ...
                if (!container.Kernel.HasComponent(nullObjectRegistrationKey))
                {
                    container.Register(
