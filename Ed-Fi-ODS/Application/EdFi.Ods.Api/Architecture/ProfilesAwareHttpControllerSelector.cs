...
namespace EdFi.Ods.Api.Architecture
{
    public class ProfilesAwareHttpControllerSelector : DefaultHttpControllerSelector
    {
        ...
        public ProfilesAwareHttpControllerSelector(HttpConfiguration config, IProfileResourcesProvider profileResourcesProvider)
            : base(config)
        {
        ...
        public override HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            {
                // If there's no controller name, defer to the base class for direct route handling
            ...
            if (profileContentTypeDetails != null)
            {
                ...
                namespaceName = profileContentTypeDetails.Profile.Replace('-', '_'); // + "_" + profileContentTypeDetails.Usage;
            ...
            // Use core controllers namespace segment
            ...
            if (_controllers.Value.TryGetValue(key, out controllerDescriptor))
            {
                ...
                if (profileControllerNotFound)
                {
                    ...
                    throw new HttpResponseException(BadRequestHttpResponseMessage(request,
                        string.Format(
            ...
            // Use non-ODS-related controller namespace segment
            namespaceName = "Controllers";
        ...
        {
            return _profileResourcesProvider.GetProfileResources().Any(x => x.ProfileName.EqualsIgnoreCase(profileName));
        }
