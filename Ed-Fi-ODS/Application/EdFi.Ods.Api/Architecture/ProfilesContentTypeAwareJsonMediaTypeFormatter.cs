    ...
    public class ProfilesContentTypeAwareJsonMediaTypeFormatter : JsonMediaTypeFormatter
    {
        ...
        public override bool CanReadType(Type type)
        {
            ...
            _alreadyProcessedByDotNetType.GetOrAdd(
                ...
                t =>
                {
                    var attribute = type.GetCustomAttributes<ProfileContentTypeAttribute>().SingleOrDefault();
            ...
            if (supportedMediaType != null)
                base.SupportedMediaTypes.Add(new MediaTypeHeaderValue(supportedMediaType));
